<%-- 
    Document   : loginConsommateur
    Created on : 2014-10-13, 17:16:00
    Author     : Usager
--%>
...
<div class="main">
<%
    if (session.getAttribute("consommateurConnecte") != null) 
    {
%>
...
%>
<div class="login">
    <h2>Connexion du consommateur</h2>
    <form action="controleur.do" method="post">
        <table>
            ...
            <tr>
                <td><input type="hidden" name="action" value="loginConsommateur" /></td><td><input type="submit" value="Connexion" /></td>
            <tr>
        </table>
    </form>
</div>
